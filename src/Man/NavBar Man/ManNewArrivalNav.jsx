...
import ManNewArrivalProducts from "../ManNewArrival/ManNewArrivalProducts";
import ManNewArrivalSingle from "../ManNewArrival/ManNewArrivalSingle";
            ...
            <div className=" container-fluid accessories_heading mb-3">
                <div className="row divh1">
                    <div className="col-lg-10 m-auto">
                        <h1 className="fs-1">MAN'S NEW ARRIVAL</h1>
                    </div>
                </div>
            </div>
